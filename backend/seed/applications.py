...
SYNTHETIC_APPLICATIONS: tuple[dict[str, object], ...] = (
    ...
    {"user_phone": "9000000016", "scheme_name": "Demo Minority Livelihood Support", "branch_code": "DEMO-PAT-016", "requested_amount": Decimal("180000.00"), "application_date": datetime(2026, 8, 16, 16, 30, tzinfo=timezone.utc), "status": ApplicationStatus.SUBMITTED.value},
    {"user_phone": "9000000017", "scheme_name": "Demo Minority Enterprise Accelerator", "branch_code": "DEMO-RAI-017", "requested_amount": Decimal("700000.00"), "application_date": datetime(2026, 8, 17, 17, 0, tzinfo=timezone.utc), "status": ApplicationStatus.REJECTED.value},
    {"user_phone": "9000000018", "scheme_name": "Demo Minority Enterprise Accelerator", "branch_code": "DEMO-BBI-018", "requested_amount": Decimal("1500000.00"), "application_date": datetime(2026, 8, 18, 17, 30, tzinfo=timezone.utc), "status": ApplicationStatus.REJECTED.value},
